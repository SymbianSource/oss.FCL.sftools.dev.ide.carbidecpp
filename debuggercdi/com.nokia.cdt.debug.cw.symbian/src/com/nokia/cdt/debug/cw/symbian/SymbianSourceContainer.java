...
public class SymbianSourceContainer extends MappingSourceContainer {
	...
	public static final String TYPE_ID = SymbianPlugin.getUniqueIdentifier() + ".containerType.mapping";	 //$NON-NLS-1$
	public static final String CONTAINER_NAME = "Symbian SDK Locator";	 //$NON-NLS-1$
