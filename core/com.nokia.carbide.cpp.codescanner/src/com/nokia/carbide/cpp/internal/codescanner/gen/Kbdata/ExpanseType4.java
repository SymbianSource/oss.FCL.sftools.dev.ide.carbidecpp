...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Expanse Type4</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getExpanseType4()
 * @model extendedMetaData="name='expanse_._4_._type'"
 * @generated
 */
public enum ExpanseType4 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Expanse Type4</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ExpanseType4[] VALUES_ARRAY =
		new ExpanseType4[] {
			PAGE,
			COLUMN,
			TEXTLINE,
	...
	/**
	 * A public read-only list of all the '<em><b>Expanse Type4</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ExpanseType4> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Expanse Type4</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType4 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ExpanseType4 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Expanse Type4</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType4 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ExpanseType4 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Expanse Type4</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType4 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ExpanseType4(int value, String name, String literal) {
		this.value = value;
		this.name = name;
