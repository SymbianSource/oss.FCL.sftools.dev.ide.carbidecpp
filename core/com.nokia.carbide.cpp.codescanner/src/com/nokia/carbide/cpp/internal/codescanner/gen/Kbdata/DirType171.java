...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Dir Type171</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getDirType171()
 * @model extendedMetaData="name='dir_._171_._type'"
 * @generated
 */
public enum DirType171 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Dir Type171</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DirType171[] VALUES_ARRAY =
		new DirType171[] {
			LTR,
			RTL,
			LRO,
	...
	/**
	 * A public read-only list of all the '<em><b>Dir Type171</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DirType171> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Dir Type171</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType171 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType171 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type171</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType171 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType171 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type171</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType171 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DirType171(int value, String name, String literal) {
		this.value = value;
		this.name = name;
