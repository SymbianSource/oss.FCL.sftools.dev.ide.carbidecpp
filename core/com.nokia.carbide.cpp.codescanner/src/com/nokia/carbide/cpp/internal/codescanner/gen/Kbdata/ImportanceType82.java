...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Importance Type82</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getImportanceType82()
 * @model extendedMetaData="name='importance_._82_._type'"
 * @generated
 */
public enum ImportanceType82 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Importance Type82</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ImportanceType82[] VALUES_ARRAY =
		new ImportanceType82[] {
			OBSOLETE,
			DEPRECATED,
			OPTIONAL,
			DEFAULT,
	...
	/**
	 * A public read-only list of all the '<em><b>Importance Type82</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ImportanceType82> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Importance Type82</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType82 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType82 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type82</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType82 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType82 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type82</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType82 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ImportanceType82(int value, String name, String literal) {
		this.value = value;
		this.name = name;
