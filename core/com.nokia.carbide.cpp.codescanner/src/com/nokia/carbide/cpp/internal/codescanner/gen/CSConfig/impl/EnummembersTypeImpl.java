...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enummembers Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.EnummembersTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.EnummembersTypeImpl#isEnable <em>Enable</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.EnummembersTypeImpl#getSeverity <em>Severity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnummembersTypeImpl extends EObjectImpl implements EnummembersType {
	/**
	...
	protected EClass eStaticClass() {
		return CSConfigPackage.eINSTANCE.getEnummembersType();
	}
	...
	public void setCategory(CategoryType newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.ENUMMEMBERS_TYPE__CATEGORY, oldCategory, category, !oldCategoryESet));
	}
	...
	public void unsetCategory() {
		...
		categoryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.ENUMMEMBERS_TYPE__CATEGORY, oldCategory, CATEGORY_EDEFAULT, oldCategoryESet));
	}
	...
	public void setEnable(boolean newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.ENUMMEMBERS_TYPE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.ENUMMEMBERS_TYPE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setSeverity(SeverityType newSeverity) {
		...
		severityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.ENUMMEMBERS_TYPE__SEVERITY, oldSeverity, severity, !oldSeverityESet));
	}
	...
	public void unsetSeverity() {
		...
		severityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.ENUMMEMBERS_TYPE__SEVERITY, oldSeverity, SEVERITY_EDEFAULT, oldSeverityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSConfigPackage.ENUMMEMBERS_TYPE__CATEGORY:
				return getCategory();
			case CSConfigPackage.ENUMMEMBERS_TYPE__ENABLE:
				return isEnable() ? Boolean.TRUE : Boolean.FALSE;
			case CSConfigPackage.ENUMMEMBERS_TYPE__SEVERITY:
				return getSeverity();
		}
