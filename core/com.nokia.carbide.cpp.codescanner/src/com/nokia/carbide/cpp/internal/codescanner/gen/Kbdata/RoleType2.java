...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Role Type2</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getRoleType2()
 * @model extendedMetaData="name='role_._2_._type'"
 * @generated
 */
public enum RoleType2 implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	PREVIOUS(5, "previous", "previous"),

	/**
	 * The '<em><b>Cousin</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COUSIN_VALUE
	 * @generated
	 ...
	 * @ordered
	 */
	DESCENDANT(8, "descendant", "descendant"),
	 ...
	 * @ordered
	 */
	DITA_USE_CONREF_TARGET(12, "ditaUseConrefTarget", "-dita-use-conref-target");
	...
	/**
	 * The '<em><b>Cousin</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Cousin</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #COUSIN
	 ...
	 * @ordered
	 */
	public static final int COUSIN_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int ANCESTOR_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int DESCENDANT_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int DITA_USE_CONREF_TARGET_VALUE = 12;

	/**
	 * An array of all the '<em><b>Role Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RoleType2[] VALUES_ARRAY =
		new RoleType2[] {
			PARENT,
			CHILD,
			SIBLING,
	...
	/**
	 * A public read-only list of all the '<em><b>Role Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RoleType2> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Role Type2</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType2 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RoleType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Role Type2</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType2 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RoleType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Role Type2</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType2 get(int value) {
		switch (value) {
			...
			case COUSIN_VALUE: return COUSIN;
	 ...
	 * @generated
	 */
	private RoleType2(int value, String name, String literal) {
		this.value = value;
		this.name = name;
