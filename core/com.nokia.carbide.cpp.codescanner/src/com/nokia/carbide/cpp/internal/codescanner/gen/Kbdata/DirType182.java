...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Dir Type182</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getDirType182()
 * @model extendedMetaData="name='dir_._182_._type'"
 * @generated
 */
public enum DirType182 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Dir Type182</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DirType182[] VALUES_ARRAY =
		new DirType182[] {
			LTR,
			RTL,
			LRO,
	...
	/**
	 * A public read-only list of all the '<em><b>Dir Type182</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DirType182> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Dir Type182</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType182 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType182 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type182</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType182 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType182 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type182</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType182 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DirType182(int value, String name, String literal) {
		this.value = value;
		this.name = name;
