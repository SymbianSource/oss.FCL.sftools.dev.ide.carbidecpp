...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type119</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType119()
 * @model extendedMetaData="name='status_._119_._type'"
 * @generated
 */
public enum StatusType119 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type119</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType119[] VALUES_ARRAY =
		new StatusType119[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type119</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType119> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type119</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType119 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType119 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type119</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType119 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType119 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type119</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType119 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType119(int value, String name, String literal) {
		this.value = value;
		this.name = name;
