...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Open Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.OpenTypeImpl#getOpenIgnoreRE <em>Open Ignore RE</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.OpenTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.OpenTypeImpl#isEnable <em>Enable</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.OpenTypeImpl#getSeverity <em>Severity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OpenTypeImpl extends EObjectImpl implements OpenType {
	/**
	...
	/**
	 * The cached value of the '{@link #getOpenIgnoreRE() <em>Open Ignore RE</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOpenIgnoreRE()
	 * @generated
	 * @ordered
	 */
	protected String openIgnoreRE = OPEN_IGNORE_RE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return CSConfigPackage.eINSTANCE.getOpenType();
	}
	...
	public void setOpenIgnoreRE(String newOpenIgnoreRE) {
		String oldOpenIgnoreRE = openIgnoreRE;
		openIgnoreRE = newOpenIgnoreRE;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.OPEN_TYPE__OPEN_IGNORE_RE, oldOpenIgnoreRE, openIgnoreRE));
	}
	...
	public void setCategory(CategoryType newCategory) {
		...
		categoryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.OPEN_TYPE__CATEGORY, oldCategory, category, !oldCategoryESet));
	}
	...
	public void unsetCategory() {
		...
		categoryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.OPEN_TYPE__CATEGORY, oldCategory, CATEGORY_EDEFAULT, oldCategoryESet));
	}
	...
	public void setEnable(boolean newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.OPEN_TYPE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.OPEN_TYPE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setSeverity(SeverityType newSeverity) {
		...
		severityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.OPEN_TYPE__SEVERITY, oldSeverity, severity, !oldSeverityESet));
	}
	...
	public void unsetSeverity() {
		...
		severityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.OPEN_TYPE__SEVERITY, oldSeverity, SEVERITY_EDEFAULT, oldSeverityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSConfigPackage.OPEN_TYPE__OPEN_IGNORE_RE:
				return getOpenIgnoreRE();
			case CSConfigPackage.OPEN_TYPE__CATEGORY:
				return getCategory();
			case CSConfigPackage.OPEN_TYPE__ENABLE:
				return isEnable() ? Boolean.TRUE : Boolean.FALSE;
			case CSConfigPackage.OPEN_TYPE__SEVERITY:
				return getSeverity();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case CSConfigPackage.OPEN_TYPE__OPEN_IGNORE_RE:
				return OPEN_IGNORE_RE_EDEFAULT == null ? openIgnoreRE != null : !OPEN_IGNORE_RE_EDEFAULT.equals(openIgnoreRE);
			case CSConfigPackage.OPEN_TYPE__CATEGORY:
