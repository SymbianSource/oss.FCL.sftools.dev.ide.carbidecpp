...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Collection Type Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getCollectionTypeType1()
 * @model extendedMetaData="name='collection-type_._1_._type'"
 * @generated
 */
public enum CollectionTypeType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Collection Type Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CollectionTypeType1[] VALUES_ARRAY =
		new CollectionTypeType1[] {
			UNORDERED,
			SEQUENCE,
			CHOICE,
			TREE,
	...
	/**
	 * A public read-only list of all the '<em><b>Collection Type Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CollectionTypeType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Collection Type Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CollectionTypeType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CollectionTypeType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Collection Type Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CollectionTypeType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CollectionTypeType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Collection Type Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CollectionTypeType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CollectionTypeType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
