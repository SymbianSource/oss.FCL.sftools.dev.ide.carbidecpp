...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type86</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType86()
 * @model extendedMetaData="name='status_._86_._type'"
 * @generated
 */
public enum StatusType86 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type86</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType86[] VALUES_ARRAY =
		new StatusType86[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type86</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType86> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type86</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType86 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType86 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type86</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType86 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType86 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type86</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType86 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType86(int value, String name, String literal) {
		this.value = value;
		this.name = name;
