...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Scale Type5</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getScaleType5()
 * @model extendedMetaData="name='scale_._5_._type'"
 * @generated
 */
public enum ScaleType5 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Scale Type5</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ScaleType5[] VALUES_ARRAY =
		new ScaleType5[] {
			_50,
			_60,
			_70,
	...
	/**
	 * A public read-only list of all the '<em><b>Scale Type5</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ScaleType5> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Scale Type5</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType5 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScaleType5 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scale Type5</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType5 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScaleType5 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scale Type5</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType5 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ScaleType5(int value, String name, String literal) {
		this.value = value;
		this.name = name;
