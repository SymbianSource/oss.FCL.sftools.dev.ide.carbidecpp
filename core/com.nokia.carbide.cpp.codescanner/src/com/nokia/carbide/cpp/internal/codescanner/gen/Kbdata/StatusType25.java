...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type25</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType25()
 * @model extendedMetaData="name='status_._25_._type'"
 * @generated
 */
public enum StatusType25 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type25</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType25[] VALUES_ARRAY =
		new StatusType25[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type25</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType25> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type25</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType25 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType25 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type25</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType25 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType25 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type25</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType25 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType25(int value, String name, String literal) {
		this.value = value;
		this.name = name;
