...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Importance Type79</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getImportanceType79()
 * @model extendedMetaData="name='importance_._79_._type'"
 * @generated
 */
public enum ImportanceType79 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Importance Type79</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ImportanceType79[] VALUES_ARRAY =
		new ImportanceType79[] {
			OBSOLETE,
			DEPRECATED,
			OPTIONAL,
			DEFAULT,
	...
	/**
	 * A public read-only list of all the '<em><b>Importance Type79</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ImportanceType79> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Importance Type79</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType79 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType79 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type79</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType79 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType79 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type79</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType79 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ImportanceType79(int value, String name, String literal) {
		this.value = value;
		this.name = name;
