...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Importance Type21</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getImportanceType21()
 * @model extendedMetaData="name='importance_._21_._type'"
 * @generated
 */
public enum ImportanceType21 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Importance Type21</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ImportanceType21[] VALUES_ARRAY =
		new ImportanceType21[] {
			OBSOLETE,
			DEPRECATED,
			OPTIONAL,
			DEFAULT,
	...
	/**
	 * A public read-only list of all the '<em><b>Importance Type21</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ImportanceType21> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Importance Type21</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType21 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType21 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type21</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType21 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType21 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type21</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType21 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ImportanceType21(int value, String name, String literal) {
		this.value = value;
		this.name = name;
