...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Variablenames Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.VariablenamesTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.VariablenamesTypeImpl#isEnable <em>Enable</em>}</li>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.VariablenamesTypeImpl#getSeverity <em>Severity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VariablenamesTypeImpl extends EObjectImpl implements VariablenamesType {
	/**
	 ...
	 * @generated
	 */
	protected VariablenamesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CSConfigPackage.eINSTANCE.getVariablenamesType();
	}
	...
	public void setCategory(CategoryType newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.VARIABLENAMES_TYPE__CATEGORY, oldCategory, category, !oldCategoryESet));
	}
	...
	public void unsetCategory() {
		...
		categoryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.VARIABLENAMES_TYPE__CATEGORY, oldCategory, CATEGORY_EDEFAULT, oldCategoryESet));
	}
	...
	public void setEnable(boolean newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.VARIABLENAMES_TYPE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.VARIABLENAMES_TYPE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setSeverity(SeverityType newSeverity) {
		...
		severityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.VARIABLENAMES_TYPE__SEVERITY, oldSeverity, severity, !oldSeverityESet));
	}
	...
	public void unsetSeverity() {
		...
		severityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.VARIABLENAMES_TYPE__SEVERITY, oldSeverity, SEVERITY_EDEFAULT, oldSeverityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSConfigPackage.VARIABLENAMES_TYPE__CATEGORY:
				return getCategory();
			case CSConfigPackage.VARIABLENAMES_TYPE__ENABLE:
				return isEnable() ? Boolean.TRUE : Boolean.FALSE;
			case CSConfigPackage.VARIABLENAMES_TYPE__SEVERITY:
				return getSeverity();
		}
