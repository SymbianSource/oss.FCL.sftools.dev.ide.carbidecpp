...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Scale Type6</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getScaleType6()
 * @model extendedMetaData="name='scale_._6_._type'"
 * @generated
 */
public enum ScaleType6 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Scale Type6</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ScaleType6[] VALUES_ARRAY =
		new ScaleType6[] {
			_50,
			_60,
			_70,
	...
	/**
	 * A public read-only list of all the '<em><b>Scale Type6</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ScaleType6> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Scale Type6</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType6 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScaleType6 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scale Type6</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType6 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScaleType6 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scale Type6</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScaleType6 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ScaleType6(int value, String name, String literal) {
		this.value = value;
		this.name = name;
