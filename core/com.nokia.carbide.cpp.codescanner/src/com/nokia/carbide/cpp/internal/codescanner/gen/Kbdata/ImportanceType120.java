...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Importance Type120</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getImportanceType120()
 * @model extendedMetaData="name='importance_._120_._type'"
 * @generated
 */
public enum ImportanceType120 implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	RECOMMENDED(7, "recommended", "recommended"),
	 ...
	 * @ordered
	 */
	DITA_USE_CONREF_TARGET(10, "ditaUseConrefTarget", "-dita-use-conref-target");
	 ...
	 * @ordered
	 */
	public static final int RECOMMENDED_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int REQUIRED_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int URGENT_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int DITA_USE_CONREF_TARGET_VALUE = 10;

	/**
	 * An array of all the '<em><b>Importance Type120</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ImportanceType120[] VALUES_ARRAY =
		new ImportanceType120[] {
			OBSOLETE,
			DEPRECATED,
			OPTIONAL,
			DEFAULT,
	...
	/**
	 * A public read-only list of all the '<em><b>Importance Type120</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ImportanceType120> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Importance Type120</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType120 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType120 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type120</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType120 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType120 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type120</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType120 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ImportanceType120(int value, String name, String literal) {
		this.value = value;
		this.name = name;
