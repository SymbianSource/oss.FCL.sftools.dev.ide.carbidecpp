...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Expanse Type3</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getExpanseType3()
 * @model extendedMetaData="name='expanse_._3_._type'"
 * @generated
 */
public enum ExpanseType3 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Expanse Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ExpanseType3[] VALUES_ARRAY =
		new ExpanseType3[] {
			PAGE,
			COLUMN,
			TEXTLINE,
	...
	/**
	 * A public read-only list of all the '<em><b>Expanse Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ExpanseType3> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Expanse Type3</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType3 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ExpanseType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Expanse Type3</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType3 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ExpanseType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Expanse Type3</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ExpanseType3 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ExpanseType3(int value, String name, String literal) {
		this.value = value;
		this.name = name;
