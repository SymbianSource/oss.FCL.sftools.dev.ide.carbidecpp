...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Valign Type3</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getValignType3()
 * @model extendedMetaData="name='valign_._3_._type'"
 * @generated
 */
public enum ValignType3 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Valign Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ValignType3[] VALUES_ARRAY =
		new ValignType3[] {
			TOP,
			MIDDLE,
			BOTTOM,
	...
	/**
	 * A public read-only list of all the '<em><b>Valign Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ValignType3> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Valign Type3</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ValignType3 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ValignType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Valign Type3</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ValignType3 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ValignType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Valign Type3</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private ValignType3(int value, String name, String literal) {
		this.value = value;
		this.name = name;
