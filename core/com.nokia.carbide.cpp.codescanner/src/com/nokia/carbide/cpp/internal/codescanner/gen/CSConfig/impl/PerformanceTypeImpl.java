...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Performance Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.carbide.cpp.internal.codescanner.gen.CSConfig.impl.PerformanceTypeImpl#isEnable <em>Enable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PerformanceTypeImpl extends EObjectImpl implements PerformanceType {
	/**
	...
	protected EClass eStaticClass() {
		return CSConfigPackage.eINSTANCE.getPerformanceType();
	}
	...
	public void setEnable(boolean newEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSConfigPackage.PERFORMANCE_TYPE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CSConfigPackage.PERFORMANCE_TYPE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSConfigPackage.PERFORMANCE_TYPE__ENABLE:
