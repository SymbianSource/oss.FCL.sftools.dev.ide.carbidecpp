...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Scope Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getScopeType1()
 * @model extendedMetaData="name='scope_._1_._type'"
 * @generated
 */
public enum ScopeType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Scope Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ScopeType1[] VALUES_ARRAY =
		new ScopeType1[] {
			LOCAL,
			PEER,
			EXTERNAL,
	...
	/**
	 * A public read-only list of all the '<em><b>Scope Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ScopeType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Scope Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScopeType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScopeType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scope Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScopeType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScopeType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scope Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private ScopeType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
