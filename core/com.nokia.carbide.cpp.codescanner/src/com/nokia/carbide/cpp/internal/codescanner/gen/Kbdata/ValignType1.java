...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Valign Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getValignType1()
 * @model extendedMetaData="name='valign_._1_._type'"
 * @generated
 */
public enum ValignType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Valign Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ValignType1[] VALUES_ARRAY =
		new ValignType1[] {
			TOP,
			MIDDLE,
			BOTTOM,
	...
	/**
	 * A public read-only list of all the '<em><b>Valign Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ValignType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Valign Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ValignType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ValignType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Valign Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ValignType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ValignType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Valign Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private ValignType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
