...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Role Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getRoleType1()
 * @model extendedMetaData="name='role_._1_._type'"
 * @generated
 */
public enum RoleType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Role Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RoleType1[] VALUES_ARRAY =
		new RoleType1[] {
			PARENT,
			CHILD,
			SIBLING,
	...
	/**
	 * A public read-only list of all the '<em><b>Role Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RoleType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Role Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RoleType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Role Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RoleType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Role Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RoleType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RoleType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
