...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Dir Type99</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getDirType99()
 * @model extendedMetaData="name='dir_._99_._type'"
 * @generated
 */
public enum DirType99 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Dir Type99</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DirType99[] VALUES_ARRAY =
		new DirType99[] {
			LTR,
			RTL,
			LRO,
	...
	/**
	 * A public read-only list of all the '<em><b>Dir Type99</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DirType99> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Dir Type99</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType99 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType99 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type99</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType99 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DirType99 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dir Type99</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DirType99 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DirType99(int value, String name, String literal) {
		this.value = value;
		this.name = name;
