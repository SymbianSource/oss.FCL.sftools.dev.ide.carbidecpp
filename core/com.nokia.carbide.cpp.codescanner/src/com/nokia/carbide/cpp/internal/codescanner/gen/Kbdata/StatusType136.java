...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type136</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType136()
 * @model extendedMetaData="name='status_._136_._type'"
 * @generated
 */
public enum StatusType136 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type136</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType136[] VALUES_ARRAY =
		new StatusType136[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type136</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType136> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type136</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType136 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType136 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type136</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType136 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType136 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type136</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType136 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType136(int value, String name, String literal) {
		this.value = value;
		this.name = name;
