...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type10</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType10()
 * @model extendedMetaData="name='status_._10_._type'"
 * @generated
 */
public enum StatusType10 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type10</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType10[] VALUES_ARRAY =
		new StatusType10[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type10</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType10> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type10</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType10 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType10 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type10</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType10 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType10 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type10</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType10 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType10(int value, String name, String literal) {
		this.value = value;
		this.name = name;
