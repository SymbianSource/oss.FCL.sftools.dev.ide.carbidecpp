...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Importance Type72</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getImportanceType72()
 * @model extendedMetaData="name='importance_._72_._type'"
 * @generated
 */
public enum ImportanceType72 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Importance Type72</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ImportanceType72[] VALUES_ARRAY =
		new ImportanceType72[] {
			OBSOLETE,
			DEPRECATED,
			OPTIONAL,
			DEFAULT,
	...
	/**
	 * A public read-only list of all the '<em><b>Importance Type72</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ImportanceType72> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Importance Type72</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType72 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType72 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type72</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType72 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ImportanceType72 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Importance Type72</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ImportanceType72 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ImportanceType72(int value, String name, String literal) {
		this.value = value;
		this.name = name;
