...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Status Type31</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.cpp.internal.codescanner.gen.Kbdata.KbdataPackage#getStatusType31()
 * @model extendedMetaData="name='status_._31_._type'"
 * @generated
 */
public enum StatusType31 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Status Type31</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StatusType31[] VALUES_ARRAY =
		new StatusType31[] {
			NEW,
			CHANGED,
			DELETED,
	...
	/**
	 * A public read-only list of all the '<em><b>Status Type31</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StatusType31> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Status Type31</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType31 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType31 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type31</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType31 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusType31 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Status Type31</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StatusType31 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StatusType31(int value, String name, String literal) {
		this.value = value;
		this.name = name;
