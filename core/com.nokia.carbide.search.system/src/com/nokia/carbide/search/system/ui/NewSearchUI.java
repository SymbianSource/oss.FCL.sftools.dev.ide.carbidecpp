 ...
 *******************************************************************************/
package com.nokia.carbide.search.system.ui;
...
public class NewSearchUI {
	 ...
	 * <code>runQueryInForeground())</code>.
	 * 
	...
	/**
	 * Search Plug-in Id (value <code>"com.nokia.carbide.search.system"</code>).
	 */
	public static final String PLUGIN_ID= "com.nokia.carbide.search.system"; //$NON-NLS-1$

	/** 
	 * Search marker type (value <code>"com.nokia.carbide.search.system.searchmarker"</code>).
	 *
	 ...
	 * (value <code>"com.nokia.carbide.search.system.ui.views.SearchView"</code>).
	 */
	public static final String SEARCH_VIEW_ID= "com.nokia.carbide.search.system.ui.views.SearchView"; //$NON-NLS-1$
	
	/**
	 * Id of the Search action set
	 * (value <code>"com.nokia.carbide.search.system.searchActionSet"</code>).
	 */
