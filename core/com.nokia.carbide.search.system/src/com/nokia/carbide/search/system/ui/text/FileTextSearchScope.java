...
import com.nokia.carbide.search.system.internal.ui.WorkingSetComparator;
...
public final class FileTextSearchScope extends TextSearchScope {
	...
	private boolean fIncludeArchives;
	...
	/**
	 * Returns a scope for the root folder, without regard to the workspace. The created scope contains all files
	 * in or beneath the root folder that match the given file name patterns. Depending on <code>includeSubfolders</code>,
	 * files in subfolders are searched. Depending on <code>includeHidden</code>, hidden files are searched.
	 * TODO: Depending on <code>includeArchives</code>, files within archive files are searched.
	 * 
	 * @param fileNamePatterns file name pattern that all files have to match <code>null</code> to include all file names.	 
	 * @param root folder defining the scope. 
	 * @param includeSubfolders defines whether subfolders are searched.
	 * @param includeHidden defines hidden files are searched.
	 * @param includeArchives TODO: defines whether files within archive files are searched.
	 * @return a scope based on the root folder.
	 */
	public static FileTextSearchScope newSystemScope(String folderName, String[] fileNamePatterns, String rootFolder,
			 				boolean includeSubfolders, boolean includeHidden, boolean includeArchives) {
		return new FileTextSearchScope(folderName, null, null, fileNamePatterns, false,
	...
	public static FileTextSearchScope newSearchScope(IResource[] roots, String[] fileNamePatterns, boolean includeDerived) {
		...
		return new FileTextSearchScope(description, roots, null, fileNamePatterns, includeDerived, null, false, false, false);
	}	
	...
	/**
	 * Returns the root folder of the search
	 * 
	 * @return root folder of the search
	 */
	...
	/**
	 * Returns whether subfolders of root folder are included in this search scope.
	 * 
	 * @return whether subfolders of root folder are included in this search scope.
	 */
	...
	/**
	 * Returns whether hidden files are included in this search scope.
	 * 
	 * @return whether hidden files are included in this search scope.
	 */
	...
	/**
	 * Returns whether archive entries are included in this search scope.
	 * 
	 * @return whether archive entries are included in this search scope.
	 */
	public boolean includeArchives() {
		return fIncludeArchives;
	}
