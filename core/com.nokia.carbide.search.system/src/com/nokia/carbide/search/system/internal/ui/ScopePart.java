...
import com.nokia.carbide.search.system.internal.ui.util.PixelConverter;
...
public class ScopePart {
	...
	// Settings store
	private static final String DIALOG_SETTINGS_KEY= "SystemSearchDialog.ScopePart"; //$NON-NLS-1$
