...
import com.nokia.carbide.search.system2.internal.ui.text2.TextSearchQueryProviderRegistry;
...
public class SearchPlugin extends AbstractUIPlugin {
	...
	/** 
	 * Filtered search marker type (value <code>"com.nokia.carbide.search.system.filteredsearchmarker"</code>).
	 *
	...
	/** 
	 * Search annotation type (value <code>"com.nokia.carbide.search.system.results"</code>).
	 *
	 * @since 3.2
	 */ 
	...
	/** 
	 * Filtered search annotation type (value <code>"com.nokia.carbide.search.system.filteredResults"</code>).
	 *
	 * @since 3.2
	 */ 
