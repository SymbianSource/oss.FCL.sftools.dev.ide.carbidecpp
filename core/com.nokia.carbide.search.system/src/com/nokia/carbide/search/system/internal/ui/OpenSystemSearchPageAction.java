 ...
 */
public class OpenSystemSearchPageAction implements IWorkbenchWindowActionDelegate {

	private static final String TEXT_SEARCH_PAGE_ID= "com.nokia.carbide.search.system.internal.ui.text.TextSearchPage"; //$NON-NLS-1$

	private IWorkbenchWindow fWindow;

	public OpenSystemSearchPageAction() {
	}
