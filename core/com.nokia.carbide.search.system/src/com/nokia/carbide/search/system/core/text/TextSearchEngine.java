...
import com.nokia.carbide.search.system.internal.core.text.TextSearchVisitor;
...
public abstract class TextSearchEngine {
	...
	public static TextSearchEngine createDefault() {
		return new TextSearchEngine() {
			...
			public IStatus search(IFileStore[] scope, TextSearchRequestor requestor, Pattern searchPattern, IProgressMonitor monitor) {
				 return new TextSearchVisitor(requestor, searchPattern).search(scope, monitor);
			}
		};
	}
	 ...
	 * @return the status containing information about problems in resources searched.
	 */
	public abstract IStatus search(IFileStore[] scope, TextSearchRequestor requestor, Pattern searchPattern, IProgressMonitor monitor);
