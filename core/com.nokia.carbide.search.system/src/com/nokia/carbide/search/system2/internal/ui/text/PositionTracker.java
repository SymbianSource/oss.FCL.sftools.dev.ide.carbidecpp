 ...
 *******************************************************************************/
package com.nokia.carbide.search.system2.internal.ui.text;
...
import com.nokia.carbide.search.system.ui.text.MatchEvent;
import com.nokia.carbide.search.system.ui.text.RemoveAllEvent;
...
public class PositionTracker implements IQueryListener, ISearchResultListener, IFileBufferListener {
	...
	public void bufferDisposed(IFileBuffer buffer) {
		...
		doForExistingMatchesIn(buffer, new IFileBufferMatchOperation() {
			/* (non-Javadoc)
			 * @see com.nokia.carbide.search.system.internal.model.PositionTracker.FileBufferMatchRunnable#run(org.eclipse.core.filebuffers.ITextFileBuffer, com.nokia.carbide.search.system.ui.model.text.Match)
			 */
	...
	/* (non-Javadoc)
	 * @see com.nokia.carbide.search.system.ui.IQueryListener#queryStarting(com.nokia.carbide.search.system.ui.ISearchQuery)
	 */
	...
	/* (non-Javadoc)
	 * @see com.nokia.carbide.search.system.ui.IQueryListener#queryFinished(com.nokia.carbide.search.system.ui.ISearchQuery)
	 */
