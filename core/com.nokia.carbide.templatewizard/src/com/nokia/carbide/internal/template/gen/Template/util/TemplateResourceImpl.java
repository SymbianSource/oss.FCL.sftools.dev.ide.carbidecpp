 ...
 * <!-- end-user-doc -->
 * @see com.nokia.carbide.internal.template.gen.Template.util.TemplateResourceFactoryImpl
 * @generated
 */
public class TemplateResourceImpl extends XMLResourceImpl {
	...
	public TemplateResourceImpl(URI uri) {
		super(uri);
		resourceSet = new ResourceSetImpl(); // TODO remove this when EMF bug 187386 is fixed
	}
