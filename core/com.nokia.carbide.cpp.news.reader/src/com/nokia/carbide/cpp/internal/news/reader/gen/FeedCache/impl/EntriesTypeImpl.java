...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entries Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.carbide.cpp.internal.news.reader.gen.FeedCache.impl.EntriesTypeImpl#getEntry <em>Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntriesTypeImpl extends EObjectImpl implements EntriesType {
	/**
	...
	protected EClass eStaticClass() {
		return FeedCachePackage.Literals.ENTRIES_TYPE;
	}
	...
	public EList<EntryType> getEntry() {
		if (entry == null) {
			entry = new EObjectContainmentEList<EntryType>(EntryType.class, this, FeedCachePackage.ENTRIES_TYPE__ENTRY);
		}
		return entry;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FeedCachePackage.ENTRIES_TYPE__ENTRY:
