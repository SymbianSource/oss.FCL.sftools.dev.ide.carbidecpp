...
import com.nokia.sdt.sourcegen.doms.rss.dom.preprocessor.IAstPreprocessorEndifDirective;

/**
 * 
 *
 */
public class AstPreprocessorEndifDirective extends AstPreprocessorDirective
        implements IAstPreprocessorEndifDirective {

    /**
     */
    public AstPreprocessorEndifDirective() {
        super();
    }
    ...
    public Object[] getTextSegments() {
        return new Object[] { "#endif", ISourceFormatter.SEGMENT_NEWLINE }; //$NON-NLS-1$
    }
