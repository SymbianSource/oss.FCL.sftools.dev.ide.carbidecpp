 ...
 *
 */
public class AstPreprocessorLocIncludeNode extends AstPreprocessorIncludeDirective
		implements IAstPreprocessorLocIncludeNode {

	public AstPreprocessorLocIncludeNode(String filename, boolean userPath, IAstSourceFile file) {
