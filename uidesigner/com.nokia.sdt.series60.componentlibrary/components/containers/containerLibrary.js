...
function getToolbar(children) {
    return findImmediateChildByComponentID(children, "com.nokia.sdt.series60.Toolbar");
}
...
function isToolbar(component) {
	return component.isOfType("com.nokia.sdt.series60.Toolbar");
}
...
function isPreviewPopUp(instance) {
	return (instance != null && instance.componentId == "com.nokia.sdt.series60.CAknPreviewPopUp");
}
