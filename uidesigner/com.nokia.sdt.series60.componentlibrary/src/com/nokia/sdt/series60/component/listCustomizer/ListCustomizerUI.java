 ...
 *
 */
public class ListCustomizerUI implements IComponentCustomizerUI {

	private EObject instance;
	private ListCustomizerComposite composite;
	private ListCustomizerCommandFactory commandFactory;

	public ListCustomizerUI(EObject instance) {
		this.instance = instance;
		commandFactory = new ListCustomizerCommandFactory();
	}
	...
	public Composite getCustomizerComposite(Composite parent) {
		...
		composite = new ListCustomizerComposite(parent, SWT.NULL, instance);
		return composite;
	}
