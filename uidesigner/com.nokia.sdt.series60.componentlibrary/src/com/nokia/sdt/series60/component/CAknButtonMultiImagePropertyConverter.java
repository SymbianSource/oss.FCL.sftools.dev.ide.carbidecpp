...
/**
 * The multi-image property converter for CAknButton, which has four images
 * sharing one MBM/MIF file.
 * 
 *
 */
public class CAknButtonMultiImagePropertyConverter extends
		SymbianMultiImagePropertyConverter {

	public CAknButtonMultiImagePropertyConverter() {
		super("bmpfile");
