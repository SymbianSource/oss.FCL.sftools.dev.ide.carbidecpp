...
HEADERFILENAME=$(HEADERDIR)\$(baseName)_aif.mbg
...
$(ICONTARGETFILENAME) : $(ICONDIR)\qgn_menu_$(baseName).svg $(ICONDIR)\present.svg $(ICONDIR)\present_excl.svg
	mifconv $(ICONTARGETFILENAME) \
		/H$(HEADERFILENAME) \
		/c32,8 $(ICONDIR)\qgn_menu_$(baseName).svg \
		/c32,8 $(ICONDIR)\present.svg \
		/c32,8 $(ICONDIR)\present_excl.svg
