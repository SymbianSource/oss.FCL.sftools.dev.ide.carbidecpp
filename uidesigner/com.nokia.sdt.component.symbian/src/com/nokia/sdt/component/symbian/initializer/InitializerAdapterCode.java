...
public class InitializerAdapterCode extends AdapterImpl implements IInitializer, ICodeImplAdapter {
	IInitializer impl = null;
	
	public InitializerAdapterCode() {
	}
	
	public void init(Object impl, EObject instance) {
		Check.checkArg(instance);
		Check.checkContract(impl instanceof IInitializer);
		
		this.impl = (IInitializer) impl;
		setTarget(instance);
	}
	
	public void initialize(boolean isConfigured) {
		impl.initialize(isConfigured);
	}
	...
	public boolean isAdapterForType(Object type) {
		return type.equals(IInitializer.class);
	}
