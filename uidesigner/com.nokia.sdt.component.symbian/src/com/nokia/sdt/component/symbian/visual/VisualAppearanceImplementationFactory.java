...
public class VisualAppearanceImplementationFactory implements IImplementationTypeFactory {

	public Class getInterface() {
		return IVisualAppearance.class;
	}

	public Class getCodeImplAdapterClass() {
		return VisualAppearanceAdapterCode.class;
	}

	public Class getScriptImplAdapterClass() {
		return VisualAppearanceAdapterScript.class;
	}
}
