...
public class ChildCommandExtenderImplementationFactory implements IImplementationTypeFactory {

	public Class getInterface() {
		return IChildCommandExtender.class;
	}

	public Class getCodeImplAdapterClass() {
		return ChildCommandExtenderAdapterCode.class;
	}
