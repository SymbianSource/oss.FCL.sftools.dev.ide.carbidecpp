...
/**
 * Provide names for dialog line ids
 * 
 *
 */
public class NameAlgorithmDialogId implements INameAlgorithm {

	public NameAlgorithmDialogId() {
	}
    ...
    public String getEnumDeclarationName(IComponentInstance instance, String containerName, String instanceName, String propertyId) {
        // make enumeration like TMyClassControls
        return "T" + TextUtils.titleCase(containerName) + "Controls"; //$NON-NLS-1$ //$NON-NLS-2$
    }
