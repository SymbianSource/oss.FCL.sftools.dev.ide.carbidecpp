...
public class ModelUpdaterImplementationFactory implements IImplementationTypeFactory {

	public Class getInterface() {
		return IModelUpdater.class;
	}

	public Class getCodeImplAdapterClass() {
		return ModelUpdaterAdapterCode.class;
	}

	public Class getScriptImplAdapterClass() {
		return ModelUpdaterAdapterScript.class;
	}
