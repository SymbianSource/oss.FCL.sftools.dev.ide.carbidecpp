...
public class ComponentEditorImplementationFactory implements IImplementationTypeFactory {

	public Class getInterface() {
		return IComponentEditor.class;
	}

	public Class getCodeImplAdapterClass() {
		return ComponentEditorAdapterCode.class;
	}
