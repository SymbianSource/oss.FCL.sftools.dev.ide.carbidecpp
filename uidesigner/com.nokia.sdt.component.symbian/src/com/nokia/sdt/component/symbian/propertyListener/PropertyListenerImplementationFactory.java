...
public class PropertyListenerImplementationFactory implements IImplementationTypeFactory {

	public Class getInterface() {
		return IComponentInstancePropertyListener.class;
	}

	public Class getCodeImplAdapterClass() {
		return PropertyListenerAdapterCode.class;
	}

	public Class getScriptImplAdapterClass() {
		return PropertyListenerAdapterScript.class;
	}
}
