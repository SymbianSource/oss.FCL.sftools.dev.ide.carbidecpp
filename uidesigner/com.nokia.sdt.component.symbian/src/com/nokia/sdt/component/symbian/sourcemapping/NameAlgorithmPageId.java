...
/**
 * Provide names for dialog page ids
 *
 */
public class NameAlgorithmPageId implements INameAlgorithm {

	public NameAlgorithmPageId() {
	}
    ...
    public String getEnumDeclarationName(IComponentInstance instance, String containerName, String instanceName, String propertyId) {
        ...
        return "T" + TextUtils.titleCase(containerName) + "Pages"; //$NON-NLS-1$ //$NON-NLS-2$
    }
