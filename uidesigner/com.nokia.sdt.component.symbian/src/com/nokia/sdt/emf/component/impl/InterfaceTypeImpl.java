 ...
 * <ul>
 *   <li>{@link com.nokia.sdt.emf.component.impl.InterfaceTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceTypeImpl extends EObjectImpl implements InterfaceType {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.INTERFACE_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.INTERFACE_TYPE__ID:
				return getId();
		}
