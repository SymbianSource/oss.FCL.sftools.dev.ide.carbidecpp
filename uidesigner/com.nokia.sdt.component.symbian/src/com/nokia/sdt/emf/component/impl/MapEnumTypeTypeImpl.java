...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Map Enum Type Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.sdt.emf.component.impl.MapEnumTypeTypeImpl#getTypeId <em>Type Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapEnumTypeTypeImpl extends MappingEnumTypeImpl implements MapEnumTypeType {
	/**
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.MAP_ENUM_TYPE_TYPE;
	}
	...
	public void setTypeId(String newTypeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MAP_ENUM_TYPE_TYPE__TYPE_ID, oldTypeId, typeId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.MAP_ENUM_TYPE_TYPE__TYPE_ID:
				return getTypeId();
		}
