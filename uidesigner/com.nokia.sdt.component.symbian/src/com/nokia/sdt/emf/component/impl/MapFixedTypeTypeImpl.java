...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Map Fixed Type Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.sdt.emf.component.impl.MapFixedTypeTypeImpl#getTypeId <em>Type Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapFixedTypeTypeImpl extends MappingFixedTypeImpl implements MapFixedTypeType {
	/**
	 ...
	 * @generated
	 */
	protected MapFixedTypeTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.MAP_FIXED_TYPE_TYPE;
	}
	...
	public void setTypeId(String newTypeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MAP_FIXED_TYPE_TYPE__TYPE_ID, oldTypeId, typeId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.MAP_FIXED_TYPE_TYPE__TYPE_ID:
				return getTypeId();
		}
