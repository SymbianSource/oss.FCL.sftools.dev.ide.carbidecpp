...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Map Instance Member Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.sdt.emf.component.impl.MapInstanceMemberTypeImpl#getMember <em>Member</em>}</li>
 *   <li>{@link com.nokia.sdt.emf.component.impl.MapInstanceMemberTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link com.nokia.sdt.emf.component.impl.MapInstanceMemberTypeImpl#isSuppressDefault <em>Suppress Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapInstanceMemberTypeImpl extends MappingInstanceTypeImpl implements MapInstanceMemberType {
	/**
	 ...
	 * @generated
	 */
    protected MapInstanceMemberTypeImpl() {
		super();
	}
    ...
    protected EClass eStaticClass() {
		return ComponentPackage.Literals.MAP_INSTANCE_MEMBER_TYPE;
	}
    ...
    public void setMember(String newMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__MEMBER, oldMember, member));
	}
    ...
    public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__PROPERTY, oldProperty, property));
	}
	...
	public void setSuppressDefault(boolean newSuppressDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__SUPPRESS_DEFAULT, oldSuppressDefault, suppressDefault, !oldSuppressDefaultESet));
	}
	...
	public void unsetSuppressDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__SUPPRESS_DEFAULT, oldSuppressDefault, SUPPRESS_DEFAULT_EDEFAULT, oldSuppressDefaultESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__MEMBER:
				return getMember();
			case ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__PROPERTY:
				return getProperty();
			case ComponentPackage.MAP_INSTANCE_MEMBER_TYPE__SUPPRESS_DEFAULT:
