...
public class NameAlgorithmNamedGroupId implements INameAlgorithm{

	public NameAlgorithmNamedGroupId() {
	}
	...
	public String getEnumDeclarationName(IComponentInstance instance,
		...
		return "T" + TextUtils.titleCase(containerName) + "commandIds"; //$NON-NLS-1$ //$NON-NLS-2$;
	}
	...
	public String getEnumeratorName(IComponentInstance instance,
        ...
        return "E" + TextUtils.titleCase(containerName) + "NamedGroup"; //$NON-NLS-1$
	}
