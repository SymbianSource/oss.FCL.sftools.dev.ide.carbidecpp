...
public class ViewLayoutInitializerFactory implements IImplFactory {
	...
	static class ViewPageInitializer implements IInitializer {
		...
		public static final String SYSTEM_CQIKCONTAINER_ITEM_COMPONENT_ID = "com.nokia.carbide.uiq.ViewPage"; //$NON-NLS-1$
