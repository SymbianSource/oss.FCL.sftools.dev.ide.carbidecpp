...
/**
 * This dialog allows editing a single image property as URI.
 * 
 *
 */
public class SingleURIImageEditorDialog extends ImageEditorDialogBase {
	 ...
	 */
	public SingleURIImageEditorDialog(Shell parentShell,
	...
	protected IImageEditorDialogMainPane createEditorPane(Composite container) {
		return new SingleURIImagePropertyEditorPane(this, container,
