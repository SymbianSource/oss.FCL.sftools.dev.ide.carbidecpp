...
/**
 * Stub implementations for all IPropertyEditorFactory methods
 *
 */
public abstract class AbstractPropertyEditorFactory implements IPropertyEditorFactory {
	...
	public ICompoundPropertyValueConverter createEditableValueConverter() {
		return null;
	}
}
