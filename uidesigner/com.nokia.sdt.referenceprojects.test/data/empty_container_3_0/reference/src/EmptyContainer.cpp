 ...
 * @return initialized instance of CEmptyContainer
 */
CEmptyContainer* CEmptyContainer::NewL( 
	...
	{
	CEmptyContainer* self = CEmptyContainer::NewLC( 
			aRect, 
			aParent, 
			aCommandObserver );
 ...
 * @param aParent owning parent, or NULL
 * @param aCommandObserver command observer
 * @return new instance of CEmptyContainer
 */
 ...
 * @param aParent owning parent, or NULL
 */ 
void CEmptyContainer::ConstructL( 
		const TRect& aRect, 
		const CCoeControl* aParent, 
		MEikCommandObserver* aCommandObserver )
	{
 ...
 */
void CEmptyContainer::LayoutControls()
	{
	}
 ...
 *	Handle key events.
 */				
TKeyResponse CEmptyContainer::OfferKeyEventL( 
 ...
 */				
void CEmptyContainer::InitializeControlsL()
	{
...
void CEmptyContainer::HandleResourceChange( TInt aType )
	...
	SetRect( iAvkonViewAppUi->View( TUid::Uid( EEmptyContainerViewId ) )->ClientRect() );
	// [[[ begin generated region: do not modify [Generated Contents]
	// ]]] end generated region [Generated Contents]
