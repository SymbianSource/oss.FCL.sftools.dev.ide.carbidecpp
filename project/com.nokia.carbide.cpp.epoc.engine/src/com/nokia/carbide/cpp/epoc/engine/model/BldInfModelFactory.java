...
import com.nokia.carbide.internal.cpp.epoc.engine.model.bldinf.BldInfModel;

import org.eclipse.core.runtime.IPath;
import org.eclipse.jface.text.IDocument;

public class BldInfModelFactory implements IModelFactory<IBldInfOwnedModel> {
	 ...
	 */
	public IBldInfOwnedModel createModel(IPath path, IDocument document) {
		return new BldInfModel(path, document);
	}
