...
public interface IASTPKGSoftwareDependencyOrVersionCompatibilityStatement
		extends IASTPKGLocalizedStatementBase {
	...
	public void setVersionLowerBound(IASTListNode<IASTLiteralTextNode> version);

	public IASTListNode<IASTLiteralTextNode> getVersionUpperBound();

	public void setVersionUpperBound(IASTListNode<IASTLiteralTextNode> version);
}
