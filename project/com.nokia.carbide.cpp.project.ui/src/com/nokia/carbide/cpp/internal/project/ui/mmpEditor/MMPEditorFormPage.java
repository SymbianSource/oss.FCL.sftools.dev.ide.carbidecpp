...
public class MMPEditorFormPage extends FormPage {

	protected final MMPEditorContext editorContext;
	protected final ControlManager controlManager = new ControlManager();

	public MMPEditorFormPage(MMPEditorContext editorContext, String id, String title) {
