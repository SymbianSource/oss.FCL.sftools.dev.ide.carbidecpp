 ...
 *
 */
public abstract class AIFEditorListPageOperation extends MultiImageEditorOperation {

	/**
	 * @param label
	 */
	public AIFEditorListPageOperation(String label, AIFEditorListPage page) {
